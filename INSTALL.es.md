...
---
<a id="install-es-contenido" name="install-es-contenido"></a>
## Contenido
...
---
<a id="install-es-prerrequisitos" name="install-es-prerrequisitos"></a>
## Prerrequisitos

<a id="install-es-requisitos-de-compilador" name="install-es-requisitos-de-compilador"></a>
...
<a id="install-es-herramientas-de-build" name="install-es-herramientas-de-build"></a>
### Herramientas de build

- **CMake** 3.18+ (3.21+ si usas `CMakePresets.json`)
- **Make** o **Ninja** (Ninja recomendado)

<a id="install-es-librerias-requeridas" name="install-es-librerias-requeridas"></a>
...
<a id="install-es-librerias-opcionales" name="install-es-librerias-opcionales"></a>
...
<a id="install-es-instalacion-en-linux" name="install-es-instalacion-en-linux"></a>
## Instalación en Linux

<a id="install-es-ubuntudebian" name="install-es-ubuntudebian"></a>
### Ubuntu/Debian
...
<a id="install-es-fedorarhel" name="install-es-fedorarhel"></a>
### Fedora/RHEL
...
<a id="install-es-arch-linux" name="install-es-arch-linux"></a>
### Arch Linux
...
<a id="install-es-compilacion-desde-el-codigo-fuente" name="install-es-compilacion-desde-el-codigo-fuente"></a>
## Compilación desde el código fuente

<a id="install-es-build-basico" name="install-es-build-basico"></a>
### Build básico
...
<a id="install-es-presets-de-cmake-opcional" name="install-es-presets-de-cmake-opcional"></a>
...
<a id="install-es-opciones-de-build" name="install-es-opciones-de-build"></a>
### Opciones de build
...
<a id="install-es-tipos-de-build" name="install-es-tipos-de-build"></a>
### Tipos de build
...
<a id="install-es-configuracion-avanzada" name="install-es-configuracion-avanzada"></a>
...
<a id="install-es-verificacion" name="install-es-verificacion"></a>
## Verificación
...
<a id="install-es-solucion-de-problemas" name="install-es-solucion-de-problemas"></a>
